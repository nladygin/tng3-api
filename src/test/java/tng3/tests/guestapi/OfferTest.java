...
import tng3.tests.guestapi.action.OfferAction;
import tng3.tests.guestapi.entity.Offers;
import tng3.tests.guestapi.entity.TimeSlotsDetails;
...
public class OfferTest extends BaseTest {
    ...
    public void getCombos() {
        ...
        offerAction.checkResponseSuccess(response, true);
        offerAction.validateResponsePayload(response, Offers.class, false);
        offerAction.checkOnOffersNumber(response, 7);
    }
